...
WebUI.click(findTestObject('Object Repository/Page_account - Space Casino/div_Deposit LimitsTap here to update24 hour_488e15'))

WebUI.click(findTestObject('Object Repository/Page_account - Space Casino/button_30 days'))

WebUI.setText(findTestObject('Object Repository/Page_account - Space Casino/input_Current Limit_amount'), '100')
