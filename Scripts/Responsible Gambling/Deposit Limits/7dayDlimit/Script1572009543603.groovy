...
WebUI.click(findTestObject('Object Repository/Page_account - Space Casino/div_Deposit LimitsTap here to update24 hours1007 days10000030 days000'))

WebUI.click(findTestObject('Object Repository/Page_account - Space Casino/button_7 days'))

WebUI.setText(findTestObject('Object Repository/Page_account - Space Casino/input_Current Limit_amount'), '1000')

WebUI.click(findTestObject('Object Repository/Page_account - Space Casino/button_Raise my limits'))
