...
WebUI.click(findTestObject('Object Repository/Page_account - Space Casino/div_Deposit LimitsTap here to update24 hour_4687cf'))

WebUI.click(findTestObject('Object Repository/Page_account - Space Casino/button_24 hours'))

WebUI.setText(findTestObject('Object Repository/Page_account - Space Casino/input_Current Limit_amount'), '10')
