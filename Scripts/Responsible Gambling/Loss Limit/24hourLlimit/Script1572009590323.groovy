...
WebUI.setText(findTestObject('Page_Login - Space Casino/input_usernameemail or phone number_username'), 'losslimittest')
...
WebUI.click(findTestObject('Object Repository/Page_account - Space Casino/a_Take A BreakTap here to update'))
