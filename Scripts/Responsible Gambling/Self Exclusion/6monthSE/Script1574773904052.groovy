...
WebUI.setText(findTestObject('Page_Login - Space Casino/input_usernameemail or phone number_username'), 'selfexclusiontest')
...
WebUI.click(findTestObject('Object Repository/Page_account - Space Casino/a_Self ExclusionTap here to update'))

WebUI.click(findTestObject('Object Repository/Page_account - Space Casino/button_6 months'))

WebUI.click(findTestObject('Page_account - Space Casino/label_By checking this box I understand tha_2d8283'))
