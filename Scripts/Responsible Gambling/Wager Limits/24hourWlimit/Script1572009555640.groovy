...
WebUI.click(findTestObject('Object Repository/Page_account - Space Casino/div_24 hours0007 days00030 days000'))

WebUI.click(findTestObject('Page_account - Space Casino/button_24 hours'))

WebUI.setText(findTestObject('Page_account - Space Casino/input_Current Limit_amount'), '1000')
