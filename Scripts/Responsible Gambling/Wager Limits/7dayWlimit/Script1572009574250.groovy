...
WebUI.click(findTestObject('Object Repository/Page_account - Space Casino/div_Wager LimitsTap here to update24 hours1000007 days00030 days000'))

WebUI.click(findTestObject('Page_account - Space Casino/button_7 days'))

WebUI.setText(findTestObject('Page_account - Space Casino/input_Current Limit_amount'), '1234')

WebUI.click(findTestObject('Page_account - Space Casino/button_Raise my limits'))
