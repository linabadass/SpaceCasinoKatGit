...
WebUI.click(findTestObject('Object Repository/Page_account - Space Casino/div_Reality CheckTap here to update60 minutes'))

WebUI.doubleClick(findTestObject('Object Repository/Page_account - Space Casino/input_Set Your Session Limit_duration'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.sendKeys(findTestObject('Object Repository/Page_account - Space Casino/input_Set Your Session Limit_duration'), Keys.chord(
        Keys.BACK_SPACE))

WebUI.setText(findTestObject('Object Repository/Page_account - Space Casino/input_Set Your Time Alert_duration'), '1')

WebUI.click(findTestObject('Object Repository/Page_account - Space Casino/button_Set Reality Check'))
