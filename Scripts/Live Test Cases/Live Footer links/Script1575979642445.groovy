...
WebUI.click(findTestObject('Page_Players Guide - Space Casino/span_Customer Complaints'))
...
WebUI.click(findTestObject('Page_Privacy Policy - Space Casino/span_Contact Us'))
